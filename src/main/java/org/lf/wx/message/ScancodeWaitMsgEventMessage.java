 ...
 */
public class ScancodeWaitMsgEventMessage extends MenuEventMessage {
	...
	private static final String RECEIVE_TEMPLATE = "<xml>"
			...
			+ "<ScanResult><![CDATA[%s]]></ScanResult>" + "</ScanCodeInfo>"
			+ "<AgentID>%s</AgentID>"
			+ "</xml>";
	 ...
	 */
	public ScancodeWaitMsgEventMessage(Message msg) {
		super(msg);
	}
