  ...
  <body>
	  <div>
            <form id="dataForm" method="post" enctype="multipart/form-data">
                <table align="center" cellspacing="10dp" style="margin-top: 15px;">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;" height="20">音&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;频:</td>
                        <td>
   	 ...
   	 $("#okBtn").linkbutton({
         ...
         onClick: function(){
             ...
             $("#dataForm").form("submit", {
                 url: getContextPath() + "/console/rwgl/zcxj/submitWXSQ.do",
                 onSubmit: function(param) {
                  	param.zcid='${jzc.id}';
                  	console.log(param.zcid);
                 },
